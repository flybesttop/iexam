/**
  * bootstrap-table - An extended Bootstrap table with radio, checkbox, getThisRole_Nodes, pagination, and other added features. (supports twitter bootstrap v2 and v3).
  *
  * @version v1.13.2
