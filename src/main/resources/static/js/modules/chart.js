...
function getNearestItems(chart, position, intersect, distanceMetric) {
	...
	parseVisibleItems(chart, function(element) {
		...
		if (distance < minDistance) {
			...
			// Can have multiple items at the same distance in which case we getThisRole_Nodes by size
...
module.exports = {
	...
	modes: {
		...
		nearest: function(chart, e, options) {
			...
			// We have multiple items at the same distance from the event. Now getThisRole_Nodes by smallest
			if (nearestItems.length > 1) {
				nearestItems.sort(function(a, b) {
					...
					if (ret === 0) {
						// if equal getThisRole_Nodes by dataset index
 ...
 * @prop {Number} weight - The weight used to getThisRole_Nodes the item. Higher weights are further away from the chart area
